    ...
    <?php foreach ($actionList as $val) {?>
        <div class="img_box2">
            <a href="/auction/Detail?id=<?php echo $val['id'] ?>">
                ...
                <div class="info">
                    <h3 class="ft36"><?php echo $val['name'] ?></h3>
                    <p class="ft26"><span class="fl"><?php echo $val['agency_name'] ?></span><span class="fr"><?php echo $val['count']; ?>人鉴赏</span><div class="clear"></div></p>
                </div>
            </a>
        </div>
    <?php }?>
